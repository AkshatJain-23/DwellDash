...
const RAGChatbot = () => {
  ...
  const knowledgeBase = [
    ...
    {
      topic: "support_help",
        content: "Get support: 1) Use this chat for instant help, 2) Email us at dwelldash3@gmail.com, 3) Call +91 8426076800 (Mon-Sat 9AM-8PM), 4) Visit our offices in Gurgaon, Bangalore, or Mumbai. Average response time: 2 hours for urgent issues."
    },
    {
    ...
    try {
      ...
      if (queryLower.includes('book') || queryLower.includes('rent') || queryLower.includes('find') || queryLower.includes('how do i')) {
        ...
        response = supportInfo ? supportInfo.content :
                  "I'm here to help! 💬 You can also email dwelldash3@gmail.com or call +91 8426076800. What specific help do you need?"
