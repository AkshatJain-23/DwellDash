  ...
  return (
    <div className="min-h-screen">
        ...
        <div className="relative container mx-auto px-4 py-20 md:py-28 text-center">
          <div className="max-w-4xl mx-auto">
            <div className="mb-6">
              ...
              <span className="block text-gray-700">PG Accommodation</span>
            </div>
            ...
            <div className="flex flex-col md:flex-row gap-4 justify-center mb-8">
              <div className="relative w-full md:w-96">
                ...
                <input
                  ...
                  className="w-full pl-10 pr-4 py-3 border border-gray-300 rounded-full text-gray-700 bg-white focus:ring-2 focus:ring-light-secondary focus:border-transparent"
                />
              </div>
              <button
                onClick={handleSearch}
                className="bg-light-secondary hover:bg-light-primary text-white px-8 py-4 rounded-full flex items-center transition-colors"
              >
            ...
            <div className="flex flex-col md:flex-row items-center justify-center gap-4">
              <div className="flex flex-row gap-4">
                <Link 
                  to="/properties" 
                  className="btn bg-white text-light-secondary hover:bg-light-highlight px-6 py-3 rounded-full font-semibold"
                >
              ...
              <Link to="/register" className="btn border-2 border-white text-white hover:bg-white hover:text-light-secondary px-6 py-3 rounded-full font-semibold">
                Sign Up Free
              </Link>
            </div>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
            {popularCities.map((city, index) => (
              <div
                ...
                className="bg-light-highlight rounded-lg p-6 text-center hover:shadow-lg transition-all duration-300 cursor-pointer hover:bg-light-primary"
              >
      ...
      <section className="py-16 bg-light-primary">
        <div className="container mx-auto px-4">
          <div className="text-center mb-12">
            <div className="inline-block bg-white text-light-secondary px-4 py-2 rounded-full text-sm font-semibold mb-4">
              WHY CHOOSE US
            </div>
            <h2 className="text-3xl md:text-4xl font-bold text-gray-900 mb-4">
            ...
            {amenities.map((amenity, index) => (
              <div key={amenity.name} className="text-center">
                <div className="w-16 h-16 bg-light-accent rounded-full flex items-center justify-center mx-auto mb-4">
                  <amenity.icon className="w-8 h-8 text-light-secondary" />
                </div>
      ...
      <section className="py-16 bg-light-secondary text-white">
        <div className="container mx-auto px-4 text-center">
          <Building2 className="w-16 h-16 mx-auto mb-6 text-light-highlight" />
          ...
          <div className="flex flex-col md:flex-row gap-4 justify-center">
            <Link 
              to="/properties" 
              className="btn bg-white text-light-secondary hover:bg-light-highlight px-8 py-3 rounded-full font-semibold"
            >
              Explore Properties
            </Link>
            <Link 
